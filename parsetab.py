...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','domopl.py',57),
  ('statement -> expression','statement',1,'p_statement_expr','domopl.py',61),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','domopl.py',65),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','domopl.py',66),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','domopl.py',67),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','domopl.py',68),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','domopl.py',75),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','domopl.py',79),
  ('expression -> NUMBER','expression',1,'p_expression_number','domopl.py',83),
  ('expression -> NAME','expression',1,'p_expression_name','domopl.py',87),
]
